    ...
    <div className="w-full h-full flex justify-center items-center">
      <div className="border py-5 px-4 rounded flex items-center flex-col">
        ...
        <div className="flex flex-col items-center gap-3 w-[30vw] pt-3">
          <form className="flex flex-col items-center gap-3 w-full" onSubmit={handleSignIn}>
          <TextField
            name="playerName"
            value={signInDetails.playerName}
            onChange={handleValueChange}
            label="Player name"
            error={isError && !signInDetails.playerName}
            helperText={isError && !signInDetails.playerName ? "Player name required" : null}
          />
          <TextField
            name="email"
            ...
            helperText={isError && !signInDetails.email ? "Email required" : null}
          />
          <TextField
            name="password"
            ...
            helperText={isError && !signInDetails.password ? "Password required" : null}
            InputProps={{
              endAdornment: (
          ...
          <div className="flex gap-2 justify-start w-full mt-3">
            <Typography variant="body2">Alreday have an account ? </Typography>
            <Link to={"/login"}>
